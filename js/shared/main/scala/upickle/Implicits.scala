 ...
 */
object Implicits extends Generated {
//  import Internal._
  import Aliases._
  import Fns._

  @inline override protected[this] final def validate[T](name: String)(pf: PartialFunction[Js.Value, T]) =
    Internal.validate(name)(pf)
...
//  implicit final val NothingW = W[Nothing](x => ???)
  ...
  private[this] final val booleanReaderFunc: JPF[Boolean] = Internal.validate("Boolean"){
    case Js.True => true
    case Js.False => false
  }
  ...
  private[this] final val stringReaderFunc: JPF[String] = Internal.validate("String"){
  ...
  implicit final val DurationR = R[Duration](Internal.validate("DurationString"){FiniteR.read orElse InfiniteR.read})
}
...
private[upickle] object Internal {
  @inline final def validate[T](name: String)(pf: PartialFunction[Js.Value, T]): PartialFunction[Js.Value, T] = {
